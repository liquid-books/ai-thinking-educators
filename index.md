---
title: "AI Thinking for Educators"
subtitle: "A Masterclass for the K–12 Teacher in the Age of Artificial Minds"
description: "Eight chapters grounded in 17 learning theories, with hands-on labs using Gemini, NotebookLM, and AI Studio. By Dr. Ernesto Lee."
---

:::{figure} images/cover.png
:label: fig-cover
:alt: AI Thinking for Educators — A Masterclass for the K–12 Teacher in the Age of Artificial Minds, by Dr. Ernesto Lee
:width: 100%
:align: center

*AI Thinking for Educators* · Dr. Ernesto Lee
:::

# AI Thinking for Educators
...
:::{note} Who This Book Is For
This book is written for you — the classroom teacher who knows something has shifted but hasn't yet been given the tools, the language, or the permission to respond to it. You don't need a computer science background. You don't need to understand how AI works at a code level. You need to understand what it means for the students in front of you and for the craft you've spent years building.
:::
...
:::{grid-item-card} Chapters 3–4 · The Tools
