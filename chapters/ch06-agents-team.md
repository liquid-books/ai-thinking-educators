---
title: "Your Synthetic Educational Team: Agents with Google Antigravity"
subtitle: "This is the chapter where you stop using AI as a tool and start hiring it as a teammate."
short_title: "Your Synthetic Educational Team"
description: "Build a personal AI workforce — a grading assistant, IEP drafter, curriculum mapper, parent writer, and sub-plan generator — using Google Antigravity. Grounded in Knowles' Andragogy and Self-Determination Theory."
label: ch-06-agents-team
tags:
  - AI agents
  - Google Antigravity
  - andragogy
...
:alt: Master infographic for Chapter 6 showing a teacher at the center of a synthetic team of five AI agents, with Andragogy principles on the left and Self-Determination Theory triangle on the right
:width: 100%
:align: center

**Chapter 6 at a Glance.** Your synthetic educational team — five specialist agents, two powerful theories, and one platform that makes it all possible. By the end of this chapter, you will have stopped thinking about AI as a tool you use and started thinking of it as a team you manage.
:::
...
## 6.1 From Tools to Teammates — What an Agent Actually Is
...
:::{figure} ../images/ch06-tool-vs-teammate.png
:label: fig-ch06-tool-vs-teammate
:alt: Horizontal spectrum showing evolution from hammer (simple tool) to calculator (passive tool) to AI tool (responds to commands) to AI agent (autonomous teammate)
:width: 90%
:align: center

**The Spectrum from Tool to Teammate.** A hammer waits for you to swing it. A calculator waits for you to press keys. An AI tool waits for you to type a prompt. An AI agent doesn't wait — it works toward a goal, using tools, making decisions, and reporting back. That difference is everything.
:::

The technical definition is worth knowing:

::::{prf:definition} AI Agent
:label: def-ai-agent

An **AI agent** is a software system that perceives its environment, makes decisions, and takes actions to achieve a defined goal — often without requiring a human prompt at each step. Unlike a simple language model that responds to queries, an agent can use tools (search the web, read documents, send emails, check calendars), maintain memory across interactions, and execute multi-step plans autonomously.
::::

Three things separate an agent from a tool:

1. **Autonomy**: The agent can act without being prompted at every step. It makes sub-decisions on its own.
2. **Tool use**: The agent can interact with external systems — your Drive, your email, your calendar — not just generate text.
3. **Goal orientation**: The agent has a defined objective it works toward, not just a query it responds to.
...
## 6.2 Why "Synthetic Employees" Are the Next Frontier in Every Profession
...
:::{note} What "Synthetic" Doesn't Mean
The word "synthetic" might trigger a warning: *fake, inferior, not the real thing.* That's not the sense here. A synthetic fabric is engineered to perform specific functions — it's not lesser than natural fiber, it's different and often better for the specific job. A synthetic employee is engineered to handle specific tasks that would otherwise take a human's irreplaceable time. It's not trying to be human. It's freeing up the human to be more fully human where it counts.
:::

---

## 6.3 Teachers Learn Like Adults Learn — Why Andragogy Makes Agents the Right Fit for You
...
:::{figure} ../images/ch06-andragogy.png
:label: fig-ch06-andragogy
:alt: Four-panel infographic showing Knowles' Andragogy principles mapped to AI agent applications for teacher-learners
:width: 90%
:align: center

**Andragogy Meets AI Agents.** Knowles identified four characteristics of adult learners. Each one maps directly to why agents are the right tool for teachers — not students, not managers, not general users. Teachers specifically.
:::
...
**Access:** [gemini.google.com](https://gemini.google.com) → Settings → Extensions
:::

:::{tab-item} AI Studio (for the builders)
...
**Access:** [aistudio.google.com](https://aistudio.google.com) with your personal Google account
:::
::::
...
Google Antigravity's full agent capabilities require **Google AI Pro** (formerly Google One AI Premium) or **AI Ultra**. Free tier users can still build limited agents using Gemini with Extensions. If you haven't upgraded yet, this is the chapter where it becomes worth it. The agents you build in this course will save you more time per week than the monthly subscription costs.
:::

---

## 6.5 The Anatomy of a Useful Agent (Goal, Tools, Memory, Guardrails)

Every good agent has four components. Get all four right and you have a teammate. Get any one wrong and you have a problem.

:::{figure} ../images/ch06-agent-anatomy.png
:label: fig-ch06-agent-anatomy
:alt: Circular anatomy diagram of an AI agent with four quadrants: Goal (top), Tools (right), Memory (left), Guardrails (bottom)
:width: 85%
:align: center

**The Anatomy of a Useful Agent.** Four components, all required. A goal without tools is a wish. Tools without guardrails are a liability. Memory without a clear goal is noise. You need all four to build an agent that actually helps.
:::
...
:::{dropdown} Deep Dive: Why Guardrails Are Not Optional
...
## 6.6 Your First Agent — The Grading Assistant
...
1. You set it up with your rubric (pasted as text or linked as a Google Doc)
2. You set it up with your feedback standards (what good, developing, and beginning responses look like)
3. When you're ready to grade, you paste in a student's submission
4. The agent evaluates it against the rubric, drafts written feedback, suggests a score, and explains its reasoning
5. You review, adjust if needed, and accept or revise
...
Always include: "TEACHER REVIEW NEEDED" at the top of your output.
```

This is your goal statement. Clean. Specific. With the guardrail built in.

:::{tip} Grading Assistant Pro Tip
Build one Grading Assistant per major assignment type, not one universal agent. A Grading Assistant calibrated for literary analysis essays will produce better feedback than one calibrated for "whatever students submit." The five minutes it takes to set up a new agent for each unit is worth it.
:::

---

## 6.7 The Specialist Roster Every Teacher Should Build

The Grading Assistant is your first hire. These are the five specialists who will complete your team.

:::{figure} ../images/ch06-specialist-roster.png
:label: fig-ch06-specialist-roster
:alt: Five business card style panels showing the teacher AI specialist roster: IEP/504 Drafter, Curriculum Mapper, Parent-Update Writer, Sub-Plan Generator, Differentiation Specialist
:width: 100%
:align: center

**Your Specialist Roster.** Five agents, five specific jobs. Each one addresses a task that currently costs you time you don't have. Together, they function as the support team every teacher deserves and almost none actually get.
:::
...
No diagnosis language. No speculation about causes of disability.
```
...
### The Differentiation Specialist
...
## 6.8 Connecting Agents to Your Existing Tools (Drive, Calendar, Gmail)
...
:::{figure} ../images/ch06-connected-tools.png
:label: fig-ch06-connected-tools
:alt: Hub and spoke diagram showing AI agent at center connected to Google Drive, Google Calendar, Gmail, Google Docs, and Google Classroom
:width: 85%
:align: center

**Your Connected Agent Ecosystem.** Each spoke represents a live connection between your agent and a tool you already use. The agent doesn't replace these tools — it orchestrates them, pulling data from where it lives and delivering output where you need it.
:::
...
```{mermaid}
graph LR
    A[Teacher Input<br/>One prompt or trigger] --> B[AI Agent<br/>Google Antigravity]
    B --> C[Google Drive<br/>Reads: roster, gradebook,<br/>lesson plans, templates]
    B --> D[Gmail<br/>Drafts: parent emails,<br/>admin updates]
    B --> E[Google Calendar<br/>Reads: schedule, events,<br/>school calendar]
    B --> F[Google Docs<br/>Creates: sub plans,<br/>unit outlines]
    C --> G[Agent<br/>Produces Output]
    D --> G
    E --> G
    F --> G
    G --> H[Teacher Review<br/>Always required]
    H --> I[Final Action<br/>Send / Save / Submit]
...
## 6.9 Supervising Your Team — Staying in the Driver's Seat
...
:::{figure} ../images/ch06-supervision.png
:label: fig-ch06-supervision
:alt: Teacher-as-supervisor diagram showing three-step cycle: Assign (teacher directs), Execute (agent works), Review (teacher approves before delivery)
:width: 85%
:align: center

**Staying in the Driver's Seat.** The agent does the work. You maintain the authority. The three-step cycle — Assign, Execute, Review — is not bureaucracy. It is the structure that keeps you professionally responsible for everything your agents produce.
:::
...
```{mermaid}
flowchart TD
    T[Teacher: Clear goal + context] --> A[Agent: Executes task]
    A --> D{Agent flags<br/>for escalation?}
    D -- Yes --> H[Teacher: Immediate review<br/>Sensitive situation]
    D -- No --> R[Agent: Produces draft output]
    R --> V[Teacher: Reviews all output]
    V --> AP{Approve?}
    AP -- Yes --> S[Send / Submit / Save]
    AP -- Revise --> E[Teacher edits]
    E --> S
    AP -- Reject --> A2[Rebriefed agent<br/>or manual action]
...
:::{warning} The Auto-Send Trap
The single most dangerous configuration in any agent setup is auto-send on email. It feels like the logical end point of automation — why review drafts if the agent is already doing it well? Here's why: because the one time it gets it wrong will be with a parent who is already in a difficult situation, at a moment when the wrong tone could escalate a manageable conflict into a formal complaint. The \$0 cost of keeping review in your workflow is always worth paying.
:::

---

## 6.10 Autonomy, Competence, Relatedness — Why Delegating to Agents Either Fuels or Drains You
...
:::{figure} ../images/ch06-sdt-diagram.png
:label: fig-ch06-sdt-diagram
:alt: Self-Determination Theory triangle with Autonomy at top, Competence at bottom right, and Relatedness at bottom left, showing how AI delegation fuels or drains teachers
:width: 85%
:align: center

**Self-Determination Theory and AI Delegation.** Your relationship with your AI agents will either fuel or drain you depending on whether it supports your autonomy, builds your competence, and honors your relatedness with students and colleagues. The same tools, set up differently, can do either.
:::
...
:::{dropdown} Research Spotlight: SDT and Technology in the Workplace
...
## 6.11 Limits, Ethics, and Honest Disclosure to Students and Parents
...
:::{figure} ../images/ch06-ethics-disclosure.png
:label: fig-ch06-ethics-disclosure
:alt: Three-column disclosure framework showing what to tell students, parents, and administration about AI-assisted teaching
:width: 90%
:align: center

**The Honest Disclosure Framework.** Transparency is not a burden — it is the foundation of trust. These three conversations — with students, with parents, and with administration — protect everyone in the room, including you.
:::
...
:::{warning} The FERPA Line
Feeding a student's full name, ID, and grade history into a personal AI account is a potential FERPA violation, regardless of how good your intentions are. Use deidentified language. Use your school Workspace account where it has been approved for use with student data. When in doubt, ask your school's privacy officer before building the agent.
:::
...
## 6.12 Building a Cohesive Team That Works the Way You Teach
...
:::{note} What You Just Built (and Why It Matters)

**The Core Argument:** You are not just a user of AI tools. You are a manager of a synthetic team. That shift — from user to manager — changes everything about how you relate to the technology and what you can demand of it.

**Andragogy (Knowles, 1968; 1970):** Adult learners — which you are — need autonomy, experience-driven tools, problem-centered design, and immediate relevance. Agents satisfy all four. They work on your terms, leverage your expertise, solve your real problems, and deliver value this week.

**Self-Determination Theory (Deci & Ryan, 1985; 2000):** AI delegation fuels you when it supports your autonomy (you chose it), builds your competence (you're more capable after), and honors your relatedness (it frees you for human connection). It drains you when it does the opposite. Design your agent relationships accordingly.

**Your Synthetic Team:**
- 🧑‍💻 **Grading Assistant** — Draft feedback on student work
- 📋 **IEP/504 Drafter** — First drafts of teacher sections
- 🗺️ **Curriculum Mapper** — Standards alignment and pacing
- ✉️ **Parent-Update Writer** — Personalized family communications
- 📁 **Sub-Plan Generator** — Complete substitute folder from one prompt
- 🎯 **Differentiation Specialist** — Three-level versions of every lesson

**The Non-Negotiables:**
1. Always review before anything leaves your desk
2. No auto-send on email
3. No student PII in personal Google accounts
4. Disclose AI-assisted workflows to students and parents
5. Stay the driver — the agent works for you, not the other way around
:::
...
### Case Study: The Sub Folder That Finally Got Built
...
1. Ms. Chen's agent is not teaching the class — a human substitute is. But Ms. Chen's professional expertise is present in every line of that sub plan. Using Knowles' andragogy or Deci and Ryan's Self-Determination Theory, explain why this kind of agent use is consistent with professional autonomy rather than a surrender of it.

2. What would have to go *wrong* with this scenario for it to become an example of irresponsible AI use? Identify at least two specific failure points and what guardrails could have prevented them.

3. What does Ms. Chen's story tell you about the difference between automation that dehumanizes work and automation that humanizes it?
...
## 🧪 Hands-On Lab: Build the "Substitute Folder" Agent (10 pts)
...
### Step 1: Gather Your Context Materials (15 min)
...
### Step 2: Write Your Agent's Goal Statement (20 min)
...
- Auto-send or auto-share anything — all output is for teacher review first
```

Spend time on this. A well-written goal statement is the difference between an agent that saves you time and one that produces output you have to rewrite entirely.
...
5. Under **Tools**, grant access to:
   - Google Drive (read-only access to your Sub Plan Agent Resources folder)
   - Google Docs (create new documents — for the output)
6. Under **Memory**, add a link to your "About My Teaching Practice" context document (if you've created one from earlier in the course) or write a brief description of your teaching context directly in the memory field.
...
### Step 5: Group Build (in-class or discussion board)
...
Submit to Canvas:
1. A screenshot or PDF of your Sub-Plan Generator agent configuration in Google Antigravity (or your Gemini session showing the goal statement and output)
2. One sample sub plan produced by your agent (the output from Step 4)
3. A 150-word reflection: What was the hardest part of writing the goal statement? What did you have to iterate on, and what did that iteration teach you about how agents work?
...
Self-Determination Theory (SDT)
  Edward Deci and Richard Ryan's framework (1985, 2000) proposing that human motivation and well-being depend on the fulfillment of three basic psychological needs: autonomy, competence, and relatedness.

Autonomy (SDT)
  In Self-Determination Theory, the need to feel that one's actions originate from one's own values and choices, rather than external pressure or control.

Competence (SDT)
  In Self-Determination Theory, the need to experience oneself as effective and capable in one's environment — the feeling of being able to do what one sets out to do.

Relatedness (SDT)
  In Self-Determination Theory, the need to feel genuinely connected to and cared for by others — to matter to the people one interacts with.

Agent Goal Statement
  The written specification that defines what an AI agent is supposed to do, in what context, with what information, in what style, and with what escalation rules. The quality of the goal statement determines the quality of the agent's output.

Tool Grant
  An explicit permission given to an AI agent to access and interact with a specific system — a Drive folder, a Gmail account, a calendar — as part of its task execution. Tool grants should be minimal (only what the agent needs) and scoped (only the specific resources it requires).

Guardrail
  A rule or constraint written into an agent's goal statement that explicitly limits what the agent can do autonomously — for example, "never send email without teacher approval" or "flag all safety-related content for immediate human review."

Memory (Agent)
  The context that an agent maintains across sessions — information about who it serves, how they work, and what preferences they have. Memory can be built through a linked context document or built-in configuration in the agent platform.

IEP (Individualized Education Program)
  A legally binding document developed for students with disabilities under IDEA (Individuals with Disabilities Education Act), specifying learning goals, services, and accommodations. Teachers contribute specific sections; AI agents can draft these sections for teacher review, never as a final product.

504 Plan
  An accommodation plan under Section 504 of the Rehabilitation Act, providing adjustments for students with disabilities in general education settings. Less intensive than an IEP, but equally important and equally subject to professional review requirements.

FERPA (Family Educational Rights and Privacy Act)
  The U.S. federal law protecting the privacy of student education records. Student personally identifiable information may not be shared with third-party AI systems without appropriate data processing agreements.

Synthetic Employee
  A colloquial term for an AI agent assigned a specific, recurring job within a professional workflow — functioning analogously to a team member with defined responsibilities, access, and authority limits.

Differentiation
  The practice of adjusting instruction, materials, or assessment to meet the varying needs of learners within the same classroom — providing appropriate challenge and support for students at different readiness levels.
```
